<x-layouts.admin :title="'Buat Kupon'">
    <div class="max-w-4xl">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Buat Kupon Baru</h2>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" required
                            placeholder="CONTOH: HOLIDAY2026"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 uppercase">
                        <p class="text-xs text-gray-500 mt-1">Gunakan huruf kapital dan angka tanpa spasi.</p>
                    </div>
