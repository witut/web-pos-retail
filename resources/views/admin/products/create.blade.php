            ...
            <div class="space-y-6">
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center cursor-pointer">
                                    <input type="radio" name="product_type" value="inventory" 
                                        ...
                                        {{ old('product_type', 'inventory') == 'inventory' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="radio" name="product_type" value="service"
                                        x-model="product_type"
                                        {{ old('product_type') == 'service' ? 'checked' : '' }}
                                        class="w-4 h-4 text-slate-600 border-gray-300 focus:ring-slate-500">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">
                                Harga Pokok (HPP) <span class="text-red-500">*</span>
                            </label>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Nilai modal per unit untuk stok awal</p>
                            @error('cost_price')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" :value="formattedSellingPrice"
                                            @input="updateSellingPriceAndMargin($event.target.value)" required placeholder="0"
                        ...
                        <template x-for="(unit, index) in units" :key="index">
                            <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                ...
                                <p class="text-xs text-gray-500 mt-2">
                                    💡 Konversi: <span x-text="unit.conversion_rate || '?'"></span> × <span x-text="'{{ old('base_unit', 'PCS') }}'"></span> = 1 <span x-text="unit.name || 'unit'"></span>
                                </p>
                            </div>
                        </template>
    ...
    @push('scripts')
        <script>
            function productForm() {
                return {
                    product_type: '{{ old('product_type', 'inventory') }}',
                    barcodes: [],
                    units: [],
                    imagePreview: null,
