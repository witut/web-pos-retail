<x-layouts.admin :title="'Buat Promosi'">
    <div class="max-w-4xl">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Buat Promosi Baru</h2>
        </div>

        <form method="POST" action="{{ route('admin.promotions.store') }}" x-data="promotionForm()">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div x-show="type === 'buy_x_get_y'" class="md:col-span-2 grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="buy_qty" min="1" step="1" value="{{ old('buy_qty') }}" :disabled="type !== 'buy_x_get_y'"
                        ...
                        <div>
                            ...
                            <input type="number" name="get_qty" min="1" step="1" value="{{ old('get_qty') }}" :disabled="type !== 'buy_x_get_y'"
                            ...
                            @foreach($products as $product)
                                <label class="flex items-center space-x-3 p-2 hover:bg-white rounded cursor-pointer" 
                                    ...
                                    <input type="checkbox" name="product_ids[]" value="{{ $product->id }}"
                                        {{ (old('product_ids') && in_array($product->id, old('product_ids'))) || ($selectedProduct && $selectedProduct->id == $product->id) ? 'checked' : '' }}
